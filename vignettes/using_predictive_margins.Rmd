...
From these numbers we can derive two weighting schemes based. Counting down the row sums, the marginal probabilities for values of `Possessor_NP_Type` are:
